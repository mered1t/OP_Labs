...
int main()
{
	...
	do {
		...
		if (snailPos <= 0) { std::cout << i << ") The snail is on the beginnig of the tree " << endl; a[i] = snailPos; i++; continue; }
		if (snailPos >= lastEl) { std::cout << i << ") The snail is on the top of the tree " << endl; a[i] = snailPos; i++; continue; }
